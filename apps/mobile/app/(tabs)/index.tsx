...
export default function Today() {
  ...
  return (
      ...
      */}
      <Animated.View entering={FadeInDown.delay(80).duration(500)}>
        ...
        >
          ...
          <Txt variant="bodyMuted" className="mt-3 text-center px-2" style={{ color: HERO.textMuted }}>
          ...
          {stats.progress.winDaysToNext !== null && (
            <View className="w-full mt-5 px-2">
              ...
              <Txt variant="caption" className="mt-2 text-center" style={{ color: HERO.textFaint }}>
    ...
    <BottomSheet visible={quickAddOpen} onClose={() => setQuickAddOpen(false)} title="Add a drink · Today">
